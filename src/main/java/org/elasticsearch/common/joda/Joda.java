...
public class Joda {
    ...
    public static FormatDateTimeFormatter forPattern(String input, Locale locale) {
        ...
        } else if ("strictDate".equals(input)) {
        ...
        } else if ("strictHour".equals(input)) {
        ...
        } else if ("strictWeekyear".equals(input) || "strict_week_year".equals(input)) {
            formatter = StrictISODateTimeFormat.weekyear();
        } else if ("strictWeekyearWeek".equals(input)) {
